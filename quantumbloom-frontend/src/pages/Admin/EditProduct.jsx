...
const EditProduct = () => {
  ...
  return (
    <div className="add-product-form">
      <h2>Editar experiencia / alojamiento</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label>Precio (por noche o por experiencia):</label>
          <input
            type="number"
            min="0"
        ...
        <div className="form-group">
          ...
          <div className="selected-dates">
            {formData.unavailableDates.map((date, idx) => (
              <div className="date-tag" key={idx}>
                {date}
                <button type="button" onClick={() => {
                  setFormData(prev => ({
                    ...prev,
                    unavailableDates: prev.unavailableDates.filter((d, i) => i !== idx),
                  }));
                }}>
                  X
                </button>
